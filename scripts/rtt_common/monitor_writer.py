...
MONITOR_COLUMNS = (
    ...
    "chassis_motor_id_2",
    "chassis_motor_id_3",
    "chassis_target_rpm_0", "chassis_target_rpm_1", "chassis_target_rpm_2", "chassis_target_rpm_3",
    "chassis_actual_rpm_0", "chassis_actual_rpm_1", "chassis_actual_rpm_2", "chassis_actual_rpm_3",
    "chassis_speed_pid_output_0", "chassis_speed_pid_output_1", "chassis_speed_pid_output_2", "chassis_speed_pid_output_3",
...
def _frame_row_values(frame: TelemetryFrame) -> tuple[object, ...]:
    ...
    return (
        ...
        frame.motor_target_rpm[0], frame.motor_target_rpm[1], frame.motor_target_rpm[2], frame.motor_target_rpm[3],
        frame.motor_rpm[0], frame.motor_rpm[1], frame.motor_rpm[2], frame.motor_rpm[3],
        frame.chassis_pid_output[0], frame.chassis_pid_output[1], frame.chassis_pid_output[2], frame.chassis_pid_output[3],
        frame.chassis_current_actual_raw[0], frame.chassis_current_actual_raw[1], frame.chassis_current_actual_raw[2], frame.chassis_current_actual_raw[3],
